...
<body>
    <div class="contenedor">
        ...
        <main class="panel">
        <h3>Ingresa la informacion del asset a eliminar:</h3>
            <form action="" method="POST">
                <table>
                <tr>
                <td><b>Seleccionar el asset</b></td>
                <td><select name="asset_del" id="asset_del"></select> <?php //Consulta a base de datos de los asset ingestados en BD?><br></td>
                </tr>
                </table>
